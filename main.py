...
from windows.select_base.select_bases import SelectBases
from services.api_connector import get_file_from_firebase
from functions.main_gcode import generate_gcode
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def create_delete_button(self, file_name, container):
        ...
        delete_button.setIcon(QtGui.QIcon(r"resources\icons\trash-can-solid.svg"))
    ...
    def export_file(self):
        ...
        if file_name:
            ...
            if extension == ".stl":
                ...
                temp_file_path = 'tempSTL.stl'
                self.output_insole_file_info['mesh'].save(temp_file_path)
                generate_gcode(temp_file_path, file_name)
