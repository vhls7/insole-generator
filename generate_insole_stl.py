...
def get_intersection(base_insole, scan_surface):
    result_1 = base_insole.boolean_difference(scan_surface)
    result_2 = base_insole.boolean_intersection(scan_surface)
...
if __name__ == "__main__":
    ...
    scan_foot.translate([0, 0, 9], inplace=True)
    parametric_insole.translate([0, 0, 3], inplace=True)
    ...
    result = get_intersection(parametric_insole, scan_foot_coord_filt_surf)
